<template>
  <div class="min-h-screen bg-bg flex">
    <AppSidebar :nav-items="navItems" role-label="الطالب" />
...
<script>
import { LayoutDashboard, FolderKanban, ListTodo, Bell } from 'lucide-vue-next'
...
export default {
  ...
  data() {
    return {
       ...
       */
      navItems: [
        { label: 'لوحة المعلومات', to: '/student', icon: LayoutDashboard, exact: true }
